...
"""Добавляем строку в начало текстовых файлов.

Скрипт добавляет строку INSERT_STRING в начало текстовых файлов
в директории FOLDER_SRC и записывает их в FOLDER_MOVE,
имя который задаёт пользователь
"""
